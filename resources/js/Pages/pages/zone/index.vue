...
export default {
    ...
    setup(props) {
        ...
        const handlePageChanged = async (page) => {
            localStorage.setItem("zones/fetch", page); // Save to localStorage
            fetchDatas(page);
        };
    ...
    mounted() {
        this.fetchDatas();
        const savedPage = localStorage.getItem("zones/fetch");
        if(savedPage){
                                    ...
                                    <tr v-for="(result, index) in results" :key="index">
                                        ...
                                        <td>
                                            ...
                                            <BButton class="btn btn-soft-info btn-sm m-2" size="sm"
                                                type="button" @click.prevent="mapData(result)" v-if="permissions.includes('view-zone-map')"
                                            ...
                                            <BButton class="btn btn-soft-danger btn-sm m-2" size="sm"
                                                type="button" @click.prevent="deleteModal(result.id)" v-if="permissions.includes('delete-price')"
