...
export default {
    ...
    setup(props) {
        ...
        const deleteData = async (dataId) => {
            try {
                await axios.delete(`/owner-complaint/delete/${dataId}`);
        ...
        const fetchDatas = async (page = 1) => {
            try {
                ...
                params.page = page;
                const response = await axios.get(`/owner-complaint/list`, { params });
        ...
        const handlePageChanged = async (page) => {
            localStorage.setItem("owner-complaint/list", page); // Save to localStorage
            fetchDatas(page);
        };
    ...
    mounted() {
        this.fetchDatas();
        const savedPage = localStorage.getItem("owner-complaint/list");
        if(savedPage){
