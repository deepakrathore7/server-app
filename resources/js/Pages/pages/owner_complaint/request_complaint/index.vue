...
export default {
    ...
    setup(props) {
        ...
        const deleteData = async (dataId) => {
            try {
                await axios.delete(`/owner-complaint/request-list/delete/${dataId}`);
        ...
        const fetchDatas = async (page = 1) => {
            try {
                ...
                params.page = page;
                const response = await axios.get(`/owner-complaint/request-list`, { params });
        ...
        const handlePageChanged = async (page) => {
            localStorage.setItem("owner-complaint/request-list", page); // Save to localStorage
            fetchDatas(page);
        };
        ...
        const updateStatus = async (result, status) => {
            try {
                ...
                const response = await axios.get(`/owner-complaint/taken/${result.id}`, {
                    params: {
                        status: status
                    }
                });
    ...
    mounted() {
        this.fetchDatas();
        const savedPage = localStorage.getItem("owner-complaint/request-list");
        if(savedPage){
